...
function typography(){
    ...
    this.createHandLetters = function(){    
        ...
        for(var i = 0; i < this.totalVerticesHandFont; i++){
            ...
            if(i % 3 === 0 && i + 3 < (this.totalVerticesHandFont+1)){
                this.faces.push(new THREE.Face3(this.f++,this.f++,this.f++));
            }
        }
        ...
        this.handFont = new THREE.Mesh(this., materialHandFont);
    ...
    this.moveBox = function () {
        ...
        if (self.isLetterToDraw && self.counter <= 1) {   
            ...
            if(this.callbackChanger!=null){
                this.callbackChanger();
            }
    ...
    this.addGeometry = function(tr, br){
        if(this.previusTR != null){
            ...
            var br = br;
            // triangles 1
            this.vertices[this.lastVerticeIndex--] = tr;
            this.vertices[this.lastVerticeIndex--] = tl;
            this.vertices[this.lastVerticeIndex--] = br;
            
            // triangle 2
            this.vertices[this.lastVerticeIndex--] = bl;
            this.vertices[this.lastVerticeIndex--] = tl;
            this.vertices[this.lastVerticeIndex--] = br;
...
typography.prototype = Object.create( THREE.Geometry.prototype );