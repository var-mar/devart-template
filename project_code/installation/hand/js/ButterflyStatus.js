		...
		switch (this.state) {
			...
			case 'resting':
				...
				if (bd > 5) { // flap wings rapidly before landing
					...
					// Faster wing flap on the hand butterfly
					this.phaseRangeTarget = 0.7;
